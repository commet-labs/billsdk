    ...
    <figure
      ...
      className={cn(
        inTab
          ...
          : "my-4 bg-fd-secondary/80 backdrop-blur-md",
        keepBackground && "bg-(--shiki-light-bg) dark:bg-(--shiki-dark-bg)",

        "shiki relative border border-fd-border shadow-sm not-prose overflow-hidden text-sm",
        props.className,
      )}
    >
      {title ? (
        <div className="flex text-fd-muted-foreground items-center gap-2 h-9.5 border-b px-4">
          {typeof icon === "string" ? (
            <div
              ...
              // biome-ignore lint/security/noDangerouslySetInnerHtml: icon HTML is from trusted source (Shiki)
...
export function CodeBlockTabs({ ref, ...props }: ComponentProps<typeof Tabs>) {
  ...
  return (
    <Tabs
      ...
      {...props}
      className={cn(
        "bg-fd-secondary/80 backdrop-blur-md border border-fd-border max-w-full overflow-hidden",
        !nested && "my-4",
        props.className,
      )}
    >
